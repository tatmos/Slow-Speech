...
class WaveformRenderer {
    ...
    render(audioBuffer, currentPlaybackTime = null) {
        ...
        // 加工後のバッファを表示
        this.drawWaveform(audioBuffer, audioBuffer.duration, width, height);
        
        // 再生位置ラインを描画
        if (currentPlaybackTime !== null) {
            this.drawPlaybackPosition(currentPlaybackTime, audioBuffer.duration, width, height);
        }
        
        // タイムルーラーを描画
        this.drawTimeRuler(audioBuffer.duration, width);
    }
